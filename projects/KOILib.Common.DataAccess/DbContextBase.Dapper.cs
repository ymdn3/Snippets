...
namespace KOILib.Common.DataAccess
{
    ...
    {
        public int Execute(
            string sql, object param = null, CommandType? commandType = null
        )
        {
        ...
        public IEnumerable<dynamic> Query(
            string sql, object param = null, bool buffered = true, CommandType? commandType = null
        )
        {
        ...
        public IEnumerable<object> Query(
            Type type, string sql, object param = null, bool buffered = true, CommandType? commandType = null
        )
        {
            return Connection.Query(type, sql, param, Transaction, buffered, CommandTimeout, commandType);
        }
        public object QueryFirst(
            Type type, string sql, object param = null, CommandType? commandType = null
        )
        {
